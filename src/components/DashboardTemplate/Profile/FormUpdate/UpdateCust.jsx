...
const UpdateCust = ({userDetails, 
    ...
    const [id_cust, setId_cust] = useState("");
    ...
    useEffect(() => {
        if (userDetails) {
            ...
            setId_cust(userDetails.id_cust || "");
            setEmail(userDetails.email || "");
            setUsername(userDetails.username || "");
            setName(userDetails.customer_name || "");
    ...
    // Filtered Cities based on Province useEffect
    useEffect(() => {
        // Filtered Cities based on Province

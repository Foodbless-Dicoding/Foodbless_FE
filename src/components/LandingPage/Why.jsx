        ...
        <section className="w-full h-fit bg-fbYellow pb-8">
            <div className="flex flex-col px-8 py-14 items-center">
                ...
                <div className="grid md:grid-cols-2 grid-cols-1 lg:grid-cols-4 gap-4 font-bold ">
                    <div id="first_why" className="why_item flex flex-col text-center items-center justify-center hover:scale-110 ">
                        <h3 className="text-fbWhite text-md w-3/4">Menikmati makanan dengan harga lebih murah.</h3>
                    </div>
                    <div id="sec_why" className="why_item flex flex-col text-center items-center justify-center hover:scale-110">
                        <h3 className="text-fbWhite text-md w-3/4">
                            Membantu Alam mengurangi limbah makanan.</h3>
                    </div>
                    <div id="thd_why" className="why_item flex flex-col text-center items-center justify-center hover:scale-110">
                        <h3 className="text-fbWhite text-md w-3/4">
                        Temukan makanan baru lokal terdekat!</h3>
                    </div>
                    <div id="fth_why" className="why_item flex flex-col text-center items-center justify-center hover:scale-110">
                        <h3 className="text-fbWhite text-md w-3/4">

                    ...
                    <form id="login_form" className="flex flex-col md:w-72">
                        ...
                        <div className="input-item flex flex-col gap-2 py-2">
                            ...
                            <div class="relative flex flex-row items-center">
                                <input id="hs-toggle-password" type="password" class="p-2 w-full text-fbDark rounded-2xl text-sm bg-fbWhite disabled:opacity-50 disabled:pointer-events-none" placeholder="Masukkan Password.."/>
                                <button type="button" data-hs-toggle-password='{
                                    "target": "#hs-toggle-password"
                                }' class="absolute -top-0.5 end-0 p-3.5 rounded-e-md">
                                <svg class="flex-shrink-0 size-3.5 text-fbDark" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">

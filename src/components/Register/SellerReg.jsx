...
const SellerReg = ({fetchProvince, fetchCity}) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await postRegister("createSeller", registerData);
        ...
        <>
            <div className="flex flex-col items-center m-6 py-2 w-[600px] bg-secondaryGreen bg-opacity-75 rounded-2xl">
                ...
                <form id="cust_register flex flex-col w-full px-4" onSubmit={handleSubmit}>
                    ...
                    <div className="input-item flex flex-col gap-2 py-2">
                            ...
                            <div className="relative flex flex-row items-center">
                                <input max={16} 
                                    ...
                                    type="password" 
                                    name="password" 
                                    className="p-2 w-full text-fbDark rounded-2xl text-sm bg-fbWhite disabled:opacity-50 disabled:pointer-events-none" placeholder="Masukkan Password.."/>
                    ...
                    <button type="submit" className="bg-fbRed my-4 py-4 text-fbWhite text-sm md:text-md w-full font-bold rounded-lg p-2">Daftar</button>
                </form>
            </div>
        </>
    );
